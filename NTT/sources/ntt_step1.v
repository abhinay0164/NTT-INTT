...
module ntt_step1 #(N=8, Q=17, W=9, WIDTH=5, STAGES=3, BUTTERFLIES=N/2)(
    input clk, rst, start,
    output reg done
    );
    ...
    bram_input b_in(.clka(clk), .ena(en), .wea(w_en), .addra(addr1_rev), .dina(din1), .douta(dout1),
    ...
    always@(*) begin
        ...
        case(state)
            ...
            COMPUTE: if(butterfly_count >= N-2) next_state = STAGE_DONE;
        ...
        if(rst) begin
            ...
            case(state)
                ...
                COMPUTE: begin
                    ...
                    butterfly_count <= butterfly_count+2;
                end
